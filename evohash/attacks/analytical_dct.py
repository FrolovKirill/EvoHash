...
64 DCT coefficients in the top-left 8×8 block of a 32×32 grayscale image.

This attack is NOT applicable to other PHFs.
"""
...
def run(context, **kwargs):
    """Run analytical DCT attack (pHash only) on all images."""
