...
Phase 2 — NES refinement: reduces L2 distortion while maintaining collision.

Reference: Chen et al., IEEE S&P 2020 (HSJA); Ilyas et al., ICML 2018 (NES).
"""
...
def _attack_single(src_img, tgt_img, target_hash, hash_fn, threshold,
                   ...
                   refine_n_iter=80, refine_n_samples=15, refine_sigma=4.0, refine_lr=2.0):
