"""Shared attack utilities for the pHash collision problem.

Imported by validate.py, context.py, and initial programs.
"""
...
def clamp_perturbation(
    ...
    Clamping is applied in the order listed above.
    """
